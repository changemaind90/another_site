const csSkins = [
  { src: 'https://via.placeholder.com/80x80?text=CS1', name: 'CS Skin 1' },
  { src: 'https://via.placeholder.com/80x80?text=CS2', name: 'CS Skin 2' },
  { src: 'https://via.placeholder.com/80x80?text=CS3', name: 'CS Skin 3' },
];
